...
public class ExternalDataServiceImpl implements ExternalDataService {
    ...
    private static final Logger log = LogManager.getLogger(ExternalDataServiceImpl.class);
    ...
    public WorkspaceItem createWorkspaceItemFromExternalDataObject(Context context,
        ...
        log.info(org.dspace.core.LogManager.getHeader(context, "create_item_from_externalDataObject", "Created item" +
